...
def gen_example(wordtoix, algo):
    ...
    # filepath = '/home/lly/HDU2022Note/cxsj/DM-GAN/T2I_CL-main/DM-GAN+CL/data/birds/example_filenames.txt' % (cfg.DATA_DIR)

    data_dic = {}
    # 这部分使用作者给出的标签中的示例文件进行预测，它是对数据集中某个特定图片的多种描述
    ...
    algo.gen_example(data_dic,sent)
def LoadModel():
    # args = parse_args()
    # if args.cfg_file is not None:
    print(os.listdir('.'))
    cfg_from_file('./ImageGenerate/DMGAN/code/cfg/eval_bird.yml')
    ...
    return algo,split_dir,dataset

def Generate(algo,split_dir,dataset):
